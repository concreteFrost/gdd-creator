      ...
      {group.mechanics.map((mechanic) => (
        <div>
          <div className={overviewStyles.mechanic_title} >
            <header className={overviewStyles.paragraph_header}>{mechanic.name}</header>
          </div>
          <section key={mechanic.id} className={overviewStyles.paragraphs_container}>
            <div className={overviewStyles.paragraph_element}>
              <header className={overviewStyles.paragraph_header}>{t.descriptionLabel}: </header>
              <div className={overviewStyles.formatted_text}>
                {formatQuillOutput(mechanic.description)}
              </div>
            </div>
            <div className={overviewStyles.paragraph_element}>
              <header className={overviewStyles.paragraph_header}>{t.typeLabel.split('*')[0]}: </header>
              <div className={overviewStyles.formatted_text}>
                {group.type.type}
              </div>
            </div>
            <div className={overviewStyles.paragraph_element}>
              <header className={overviewStyles.paragraph_header}>{t.examplesLabel}: </header>
              <div className={overviewStyles.formatted_text}>
                <ul>
